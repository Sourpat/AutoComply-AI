...
Tests for case lifecycle management: status transitions, notes, decisions, timeline.
"""
...
pytestmark = pytest.mark.skip(reason="Legacy Phase 2 backend tests moved to tests/legacy. Run explicitly via pytest backend/tests/legacy -q")
