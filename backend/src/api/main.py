...
from src.api.routes import verifier_smoke
from src.api.routes import submitter_submissions
...
app.include_router(verifier_smoke.router)
app.include_router(submitter_submissions.router)
